...
$router->get('/redefinir-senha', [AuthController::class, 'resetForm']);
$router->post('/redefinir-senha', [AuthController::class, 'reset']);
...
$router->post('/portaria/retiradas/confirmar-chave', [PortariaController::class, 'confirmarRetiradaChave']);
$router->post('/portaria/retiradas/fechar-solicitacao', [PortariaController::class, 'fecharSolicitacaoRetirada']);
$router->get('/portaria/retiradas/pendentes', [PortariaController::class, 'solicitacoesRetiradaPendentes']);
...
$router->post('/portaria/reservas/excluir-em-lote', [PortariaController::class, 'excluirReservasEmLote']);
