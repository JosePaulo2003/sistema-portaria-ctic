...
<div class="dashboard-grid">
    ...
    <a class="card card-link" href="<?= e(baseUrl('/portaria/salas')) ?>"><h2>Salas</h2><p>Criar e manter ambientes.</p></a>
    <a class="card card-link" href="<?= e(baseUrl('/portaria/itens')) ?>"><h2>Itens</h2><p>Criar itens de portaria.</p></a>
