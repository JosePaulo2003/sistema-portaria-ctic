<?php
/**
 * GUIA DE MANUTENCAO: Este arquivo renderiza a tela solicitacoes do módulo usuarios.
 *
                        ...
                        <?php if ($solicitacao['situacao'] === 'pendente'): ?>
                            ...
                            <form method="post" action="<?= e(baseUrl('/desenvolvedor/usuarios/solicitacoes/aprovar')) ?>" class="solicitacao-approval-form">
                                ...
                                <div class="solicitacao-submit-actions">
                                    <button class="button" type="submit">Aprovar, criar e enviar e-mail</button>
                                    <small>O e-mail receberá o nome, o perfil, o link do SGRP e esta mesma senha inicial.</small>
                                </div>
                            </form>
